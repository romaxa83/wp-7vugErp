    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td style="padding: 0 0 0 5px;font-size: 12px;border: 1px solid rgb(200,202,203)"><?= formatedPriceUSD($product[$i]->price); ?></td>
                <td style="padding: 0 0 0 5px;font-size: 12px;border: 1px solid rgb(200,202,203)"><?= formatedPriceUSD(getConvertUSDinUAH($product[$i]->price, $product[$i]->transaction->course)); ?></td>
                <td style="padding: 0 0 0 5px;font-size: 12px;border: 1px solid rgb(200,202,203)"><?= formatedPriceUSD($product[$i]->price * $product[$i]->amount); ?></td>
                <td style="padding: 0 0 0 5px;font-size: 12px;border: 1px solid rgb(200,202,203)"><?= formatedPriceUSD(getConvertUSDinUAH($product[$i]->price * $product[$i]->amount, $product[$i]->transaction->course)); ?></td>
            </tr>
        <?php endfor;?>
    </tbody>
</table>